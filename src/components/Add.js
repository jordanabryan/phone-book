...
class Add extends React.Component {
	constructor(props){
		...
		this.onWebsiteInput = this.onWebsiteInput.bind(this);
		this.onDobInput = this.onDobInput.bind(this);
		this.onFacebookInput = this.onFacebookInput.bind(this);
		this.onFacebookInput = this.onInstagramInput.bind(this);
		this.onTwitterInput = this.onTwitterInput.bind(this);
...
Add.propTypes = {
	setAddContact: PropTypes.func.isRequired,
	removeAddContact: PropTypes.func.isRequired,
